                ...
                <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                   ...
                   text-violet-500 font-bold">BDCrowdFunding</a>
                            ...
                            <div className="col-span-2 sm:col-span-1">
                                <p className="font-medium text-gray-900">Our Campaigns</p>
                    ...
                    <div className="mt-8 border-t border-gray-100 pt-8">
                        <div className="sm:flex sm:justify-between">
                            <p className="text-xs text-gray-500">&copy; 2025. BDCrowdFunding. All rights reserved.</p>
                            <p className="text-xs text-gray-500"><TypeWriter></TypeWriter></p>
